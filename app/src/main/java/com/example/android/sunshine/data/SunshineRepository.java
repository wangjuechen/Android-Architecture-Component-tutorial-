...
public class SunshineRepository {
    ...
    private SunshineRepository(WeatherDao weatherDao,
        ...
        LiveData<WeatherEntry[]> networkData = mWeatherNetworkDataSource.getmDownloadWeatherForecasts();
    ...
    private boolean isFetchNeeded() {
        Date today = SunshineDateUtils.getNormalizedUtcDateForToday();
        return mWeatherDao.countAllFurtherWeather(today) < WeatherNetworkDataSource.NUM_DAYS;
    }
